...
if __name__ == "__main__":
	...
	parser.add_argument("manual_file", help = "manual grade file (either from autopick.sh or generated by gen_manual_pick.sh)", type = str)
	parser.add_argument("sac_folder", help = "sac_picks folder to compare and grade")
	parser.add_argument("-d", "--dryrun", action = "store_true", help = "dry run")
	
	args = parser.parse_args()

	main(args.manual_file, args.sac_folder, args.dryrun)
