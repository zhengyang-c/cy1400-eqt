...
awk -F, '{print $9, $8, $10}' $PLOTFILE | gmt psxy $PROJ $LIMS -Sc0.05i -W0.5p -Ctemp.cpt -K -O >> $PSFILE
...
printf "96.5 6 After REAL" | gmt pstext $PROJ $LIMS -F+jTR -D-0.1/-0.1 -K -O >> $PSFILE
