...
gmt psbasemap $PROJ $LIMS -Bxa0.01 -Bya0.01 -BWeSn -K -O  --FORMAT_GEO_MAP=D>> $PSFILE
...
awk '/TA/{print $2, $3}' station_info.dat | gmt psxy $PROJ $LIMS -St0.15i -W0.25p -Gred -K -O >> $PSFILE
awk '/TA/{print $2, $3, $1}' station_info.dat | gmt pstext $PROJ $LIMS -D0.5i/0 -O >> $PSFILE
