...
def recompute_from_sac_source(sac_select, detection_csv, output_csv, hdf5_folder):
	...
	det_df = df.merge(hdf, on = "file_name")
...
if __name__ == "__main__":
	...
	recompute_from_sac_source(args.sac_csv, args.csv_file, args.save_csv, args.hdf5_folder)
