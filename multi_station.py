...
if __name__ == "__main__":
	...
	parser.add_argument("-mergecsv", action = "store_true", help = "flag to merge multiple csvs")
	parser.add_argument("-recomputesnr", action = "store_true", help = "flag to recompute snrs")


	parser.add_argument("-filtercsv", action = "store_true", help = "flag to filter csvs")
	parser.add_argument("-writeheaders", action = "store_true", help = "flag to write sac headers")
	...
	parser.add_argument("-makesaccsv", help = "flag to make the job csv", action = "store_true", default = False)
