...
python multi_station.py -encode -i /home/zchoong001/cy1400/cy1400-eqt/station/TA_all.txt -make_sac -s 2020.150 -e 2020.160 -job 7aug_nodropout_test -write_hdf5 -run_eqt -merge_csv -pbs -n_multi 5
