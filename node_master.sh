...
python multi_station.py -encode -i /home/zchoong001/cy1400/cy1400-eqt/station/30jun_rerun_GE0203.txt -job 30jun_rerun_GE0203_Mar -s 2020.061 -e 2020.091 -pbs -make_sac_csv -write_hdf5 -run_eqt -merge_csv -recompute_snr -filter_csv -plot_eqt -write_headers -no_execute
