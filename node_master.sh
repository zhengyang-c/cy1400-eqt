...
python multi_station.py -encode -i /home/zchoong001/cy1400/cy1400-eqt/station/A_all.txt -job 06jul_leftover_A_all -s 2020.001 -e 2020.366 -pbs -write_hdf5 -merge_csv -recompute_snr -filter_csv -plot_eqt -write_headers -sac_select /home/zchoong001/cy1400/cy1400-eqt/missing_sac_5jul.csv
