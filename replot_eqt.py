...
if __name__ == "__main__":
	...
	parser.add_argument('input_csv', help = "csv file with all the source SAC files")
	...
	sac_plotter(args.input_csv, args.csv_file)
	header_writer(args.input_csv, args.csv_file)
