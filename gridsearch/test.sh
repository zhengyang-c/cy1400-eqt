...
gmt makecpt -Crainbow -T0/20/1 > temp.cpt



gmt grdimage 000055/000055_DX0.01_DZ1.0.grd $PROJ $LIMS -Ctemp.cpt -K > $PSFILE
...
gmt psscale $PROJ $LIMS -Dg95.75/4.1+w10c/0.5c+jBC+h -G0/20/2 -Ctemp.cpt --LABEL_FONT_SIZE=8 -K -O >> $PSFILE
